class Timer {
	...
	dataJcdecaux() {
		ajaxGet("https://api.jcdecaux.com/vls/v1/stations?contract=Lyon&apiKey=d9ce4a4ff8aee76cf49b9b8394047ea940b54c4d",function(reponse) {
			...
			// Récupération de l'adresse de la gare contenue dans le formulaire.
			let adresse = document.getElementById("adresse").textContent;

			for (element in obj.tabJcdecauxLyon) {
			// Si l'adresse saisie dans le formulaire correspond à une adresse dans la ville de Lyon récupération du nom de la gare.
